...
: ${AMENT_CURRENT_PREFIX:="/home/tazimo/tazimo_ws/install/vel-to-ser"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vel-to-ser/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vel-to-ser/environment/path.sh"
